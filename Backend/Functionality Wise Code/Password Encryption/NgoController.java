...
public class NgoController {
	...
	public Ngo regNgo(@RequestBody NgoReg o )
	{
		...
		String encrypted = PassBasedEnc.generateSecurePassword(o.getPassword(),saltvalue.getSalt());

		Login l = new Login(o.getUser_name(),encrypted,r,false,o.getEmail(),o.getQue_id(),o.getAnswer());
